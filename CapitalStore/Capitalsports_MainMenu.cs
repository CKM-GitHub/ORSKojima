...
namespace MainMenu
{
    public partial class Capitalsports_MainMenu : Form
    {
        ...
        private void Capital_MainMenu_Load(object sender, EventArgs e)
        {
            ...
            var len = Convert.ToInt32((630- (mse2.StoreName.Trim().Length*2))/2);
            ckM_Label1.Text = mse2.StoreName.Trim();
            ckM_Label1.Padding = new Padding( len,0,0,0);
          //  ckM_Label1.TextAlign = HorizontalAlignment.Center; 
            //ckM_Label1.AutoSize = false;
        }
        ...
        {
            (sender as CKM_Button).BackgroundImage = CapitalStore.Properties.Resources.bm_3;
            (sender as CKM_Button).ForeColor = Color.White;
        }
        private void panelLeft_MouseEnter(object sender, EventArgs e)
        {
            (sender as CKM_Button).BackgroundImage = CapitalStore.Properties.Resources.bmback_3;
        ...
        {
            (sender as CKM_Button).BackColor = Color.Transparent;
            (sender as CKM_Button).BackgroundImage = CapitalStore.Properties.Resources.bn_9;
        ...
        protected DataTable getd()
        {
            ...
            // SqlConnection conn = new SqlConnection("Data Source=202.223.48.145;Initial Catalog=CapitalStore;Persist Security Info=True;User ID=sa;Password=admin123456!");
        ...
        {
            (sender as CKM_Button).BackgroundImage = CapitalStore.Properties.Resources.bn_10;
            (sender as CKM_Button).ForeColor = Color.White;
        }
        ...
        {
            (sender as CKM_Button).BackgroundImage = CapitalStore.Properties.Resources.bn_12;
            (sender as CKM_Button).ForeColor = Color.White;
        }
    }
}
