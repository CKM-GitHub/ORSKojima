...
namespace MainMenu
{
    public partial class CapitalsportsLogin : Form
    {
        ...
        {
            Process[] localByName = Process.GetProcessesByName("CapitalStore");
        ...
        private void CapitalsportsLogin_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)'c')
            {
                if (!IsKeyCUsed)
        ...
        private void CapitalsportsLogin_FormClosing(object sender, FormClosingEventArgs e)
        {
            Process[] localByName = Process.GetProcessesByName("CapitalStore");
