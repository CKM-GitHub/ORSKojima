    ...
    static class Program
    {
        ...
        public static void CreateIfMissingAsync()
        {
            ...
            try
            {
                if (!File.Exists(@"C:\SMS\AppData\CKM.ini"))
                {
                    ...
                    text = text.Replace("=TennicMainMenuLogin", "=CapitalStoreMenuLogin");
                    text = text.Replace("=HaspoMainMenuLogin", "=CapitalStoreMenuLogin");
                    text = text.Replace("=HaspoStoreMenuLogin", "=CapitalStoreMenuLogin");
                    text = text.Replace("=CapitalStoreMenuLogin", "=CapitalStoreMenuLogin");
                    text = text.Replace("=CapitalMainMenuLogin", "=CapitalStoreMenuLogin");
                    File.WriteAllText(@"C:\SMS\AppData\CKM.ini", text);
                }
                else
                {
                    string text = File.ReadAllText(@"C:\SMS\AppData\CKM.ini");
                    //if ( text.Contains("=CapitalStoreMenuLogin"))
                    //{
                    //    //ok
                    //}
                    //else
        ...
        static Form LoginFormName()
        {
            ...
            if (!System.Deployment.Application.ApplicationDeployment.IsNetworkDeployed)
            {
                ...
                localpath = localpath.Replace("CapitalStore\\", "");
            }
