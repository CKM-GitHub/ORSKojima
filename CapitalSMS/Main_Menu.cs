    ...
    public partial class Main_Menu : Form
    {
            ...
            for (int i = 0; i < c.Count(); i++)
            {
                ...
                if (ctrl is CKM_Button)
                {
                    ...
                    if ((ctrl as CKM_Button).Parent is Panel && (((ctrl as CKM_Button).Parent as Panel).Name == "panelLeft" || ((ctrl as CKM_Button).Parent as Panel).Name == "panel_right"))
                    {
                        ...
                        {
                            (ctrl as CKM_Button).BackgroundImage = CapitalSMS.Properties.Resources.bn_9;
                        ...
                        else
                        {
                            if (state == 0 || state == 1)
                            {
                                (ctrl as CKM_Button).BackgroundImage = CapitalSMS.Properties.Resources.bm_3;
                            }
                            else if (state == 2)
                            {
                                (ctrl as CKM_Button).BackgroundImage = CapitalSMS.Properties.Resources.MTennic;// Image.FromFile(fbase + "MTennic.png");
                            }
                            else if (state == 3)
                            {
                                (ctrl as CKM_Button).BackgroundImage = CapitalSMS.Properties.Resources.MHaspo; //Image.FromFile(fbase + "MHaspo.png");
                                (ctrl as CKM_Button).ForeColor = Color.Black; ;
                            }
                            else if (state == 4)
                            {
                                (ctrl as CKM_Button).BackgroundImage = CapitalSMS.Properties.Resources.MOther; //Image.FromFile(fbase + "MOther.png");
                            }
        ...
        private void panelRight_MouseEnter(object sender, EventArgs e)
        {
            ...
            else if (Hstate == 2)
            {
                ...
                (sender as CKM_Button).BackgroundImage = CapitalSMS.Properties.Resources.HTennic; //Image.FromFile(fbase + "HTennic.png");
                (sender as CKM_Button).ForeColor = Color.Black;
            }
            else if (Hstate == 3)
            {
                (sender as CKM_Button).BackgroundImage = CapitalSMS.Properties.Resources.HHaspo;// Image.FromFile(fbase + "HHaspo.png");
                (sender as CKM_Button).ForeColor = Color.White;
            }
            else if (Hstate == 4)
            {
                (sender as CKM_Button).BackgroundImage = CapitalSMS.Properties.Resources.HOther;// Image.FromFile(fbase + "HOther.png");
                (sender as CKM_Button).ForeColor = Color.Black;
            }
        }
        ...
        private void panelRight_MouseLeave(object sender, EventArgs e)
        {
            ...
            {
                (sender as CKM_Button).BackgroundImage = CapitalSMS.Properties.Resources.bn_9;
                (sender as CKM_Button).ForeColor = Color.Black;
            }
        }
        private void panelLeft_MouseEnter(object sender, EventArgs e)
        {
            ...
            else if (Hstate == 2)
            {
                ...
                (sender as CKM_Button).BackgroundImage = CapitalSMS.Properties.Resources.HTennic;// HOther  Image.FromFile(fbase+"HTennic.png");
                (sender as CKM_Button).ForeColor = Color.Black;
            }
            else if (Hstate == 3)
            {
        ...
        private void panelLeft_MouseLeave(object sender, EventArgs e)
        {
            ...
            if (Mstate == 2)
            {
                (sender as CKM_Button).BackgroundImage = CapitalSMS.Properties.Resources.MTennic;// Image.FromFile(fbase + "MTennic.png");
                (sender as CKM_Button).ForeColor = Color.White;
            }
            else if (Mstate == 3)
            {
                (sender as CKM_Button).BackgroundImage = CapitalSMS.Properties.Resources.MHaspo;// Image.FromFile(fbase + "MHaspo.png");
                (sender as CKM_Button).ForeColor = Color.Black;
            }
            else if (Mstate == 4)
            {
                (sender as CKM_Button).BackgroundImage = CapitalSMS.Properties.Resources.MOther;// Image.FromFile(fbase + "MOther.png");
                (sender as CKM_Button).ForeColor = Color.White;
            }
        }
        ...
        {
            (sender as CKM_Button).BackgroundImage = CapitalSMS.Properties.Resources.bn_15;
            // 
            //if (!Defg)
        ...
        {
            (sender as PictureBox).Image = CapitalSMS.Properties.Resources.img_380355;
        }
        private void pictureBox2_MouseLeave(object sender, EventArgs e)
        {
            (sender as PictureBox).Image = CapitalSMS.Properties.Resources.HoverSetting;
        }
    }
}
