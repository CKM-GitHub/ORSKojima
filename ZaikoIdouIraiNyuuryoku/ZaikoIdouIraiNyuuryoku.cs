                ...
                case (int)EIndex.JANCD:
                    ...
                    if (detailControls[index].Enabled)
                    {
                        ...
                        else
                        {
                            ...
                            //Ｅ１９３
                            //bbl.ShowMessage("E193");//2022/01/13
                        ...
                        if (selectRow != null)
                        {
                            ...
                            for (int RW = 0; RW <= mGrid.g_MK_Max_Row - 1; RW++)
                            {
                                ...
                                if (string.IsNullOrWhiteSpace(mGrid.g_DArray[RW].JanCD) == false)
                                {
                                    ...
                                    //if (mGrid.g_DArray[RW].JanCD.Equals(selectRow["JanCD"].ToString()))
                                    {
                                        //Ｅ１９３
                        ...
                        var setKBN = selectRow["SetKBN"].ToString();
                        if (setKBN == "1")
                        {
                            bbl.ShowMessage("E172");
                            return false;
                        }
                        var discountKBN = selectRow["DiscountKBN"].ToString();
                        if (discountKBN == "1")
                        {
