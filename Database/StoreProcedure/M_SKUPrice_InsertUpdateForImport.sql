...
BEGIN
	...
	Create table [#tmpSKUPrice](
				TankaCD [varchar](13) collate database_default NOT NULL,
				StoreCD [varchar](4) collate database_default NOT NULL,
				...
				Remarks  [varchar](500) collate database_default NULL,
				DeleteFlg [int]
				)
