...
BEGIN  
    ...
    SELECT ROW_NUMBER()OVER(ORDER BY DJUD.VendorCD,DJUD.JuchuuNO,DJUD.DisplayRows) AS GyouNO    
          ...
          --,CASE WHEN DJUD.DirectFlg = 0 THEN MSOU.SoukoName ELSE DDEP.DeliveryName END AS NounyuusakiName  --old code
          --HET TaskNo3049		 
		  ,CASE WHEN DJUD.DirectFlg = 0 THEN  MSOU.SoukoName 
	            WHEN DJUD.DirectFlg = 1
			         THEN
						CASE WHEN DDEP.DeliveryName IS NOT NULL THEN DDEP.DeliveryName
							 WHEN DDEP.DeliveryName IS NULL THEN DJUH.DeliveryName
						END
			END AS NounyuusakiName
          ,DJUD.DirectFlg AS NounyuusakiKBN    
          --,CASE WHEN DJUD.DirectFlg = 0 THEN MSOU.Address1 + ' ' + MSOU.Address2 ELSE DDEP.DeliveryAddress1 + ' ' + DDEP.DeliveryAddress2 END AS NounyuusakiJuusho  --old code
          --HET TaskNo3049
		   ,CASE WHEN DJUD.DirectFlg = 0 THEN MSOU.Address1 + ' ' + MSOU.Address2 
		         WHEN DJUD.DirectFlg = 1 THEN
					CASE WHEN DDEP.DeliveryName IS NOT NULL THEN DDEP.DeliveryAddress1 + ' ' + DDEP.DeliveryAddress2 
						 WHEN DDEP.DeliveryName IS NULL THEN DJUH.DeliveryAddress1 + ' ' + DJUH.DeliveryAddress2 END END AS NounyuusakiJuusho  
		   ,CASE WHEN DJUD.DirectFlg = 1 THEN 
					CASE WHEN DDEP.DeliveryName IS NOT NULL THEN DDEP.DeliveryZip1CD
						 WHEN DDEP.DeliveryName IS NULL THEN DJUH.DeliveryZipCD1 END END AS NounyuusakiYuubinNO1  
		   ,CASE WHEN DJUD.DirectFlg = 1 THEN 
					CASE WHEN DDEP.DeliveryName IS NOT NULL THEN DDEP.DeliveryZip2CD
						 WHEN DDEP.DeliveryName IS NULL THEN DJUH.DeliveryZipCD2 END END AS NounyuusakiYuubinNO2  
		   ,CASE WHEN DJUD.DirectFlg = 1 THEN 
					CASE WHEN DDEP.DeliveryName IS NOT NULL THEN DDEP.DeliveryAddress1
						 WHEN DDEP.DeliveryName IS NULL THEN DJUH.DeliveryAddress1 END END AS NounyuusakiJuusho1  
		   ,CASE WHEN DJUD.DirectFlg = 1 THEN 
					CASE WHEN DDEP.DeliveryName IS NOT NULL THEN DDEP.DeliveryAddress2
						 WHEN DDEP.DeliveryName IS NULL THEN DJUH.DeliveryAddress2 END END AS NounyuusakiJuusho2  
		   ,CASE WHEN DJUD.DirectFlg = 1 THEN
					CASE WHEN DDEP.DeliveryName IS NOT NULL THEN DDEP.DeliveryTelphoneNO
						 WHEN DDEP.DeliveryName IS NULL THEN DJUH.DeliveryTel11 + ' ' + DJUH.DeliveryTel12 + ' '+ DJUH.DeliveryTel13  END END AS TELNO    
		   ,CASE WHEN DJUD.DirectFlg = 1 THEN 
					CASE WHEN DDEP.DeliveryName IS NOT NULL THEN DDEP.DeliveryFaxNO
						 WHEN DDEP.DeliveryName IS NULL THEN DJUH.DeliveryTel21 + ' ' + DJUH.DeliveryTel22 + ' '+ DJUH.DeliveryTel23  END END AS FAXNO  
          ,MSOU.SoukoCD    
          ...
          ,CASE WHEN DJUD.DirectFlg = 0 THEN NULL ELSE DDEP.DeliveryFaxNO END       AS NounyuusakiFAXNO    */ --old code
          --HET TaskNo3049
		  ,CASE WHEN DJUD.DirectFlg = 0 THEN NULL WHEN DJUD.DirectFlg = 1 THEN CASE WHEN DDEP.DeliveryName IS NOT NULL THEN DDEP.DeliveryZip1CD WHEN DDEP.DeliveryName IS NULL THEN DJUH.DeliveryZipCD1 END END AS NounyuusakiYuubinNO1    
          ,CASE WHEN DJUD.DirectFlg = 0 THEN NULL WHEN DJUD.DirectFlg = 1 THEN CASE WHEN DDEP.DeliveryName IS NOT NULL THEN DDEP.DeliveryZip2CD WHEN DDEP.DeliveryName IS NULL THEN DJUH.DeliveryZipCD2 END END AS NounyuusakiYuubinNO2    
          ,CASE WHEN DJUD.DirectFlg = 0 THEN NULL WHEN DJUD.DirectFlg = 1 THEN CASE WHEN DDEP.DeliveryName IS NOT NULL THEN DDEP.DeliveryAddress1 WHEN DDEP.DeliveryName IS NULL THEN DJUH.DeliveryAddress1 END END AS NounyuusakiJuusho1    
          ,CASE WHEN DJUD.DirectFlg = 0 THEN NULL WHEN DJUD.DirectFlg = 1 THEN CASE WHEN DDEP.DeliveryName IS NOT NULL THEN DDEP.DeliveryAddress2 WHEN DDEP.DeliveryName IS NULL THEN DJUH.DeliveryAddress2 END END AS NounyuusakiJuusho2    
          ,CASE WHEN DJUD.DirectFlg = 0 THEN NULL WHEN DJUD.DirectFlg = 1 THEN CASE WHEN DDEP.DeliveryName IS NOT NULL THEN DDEP.DeliveryMailAddress WHEN DDEP.DeliveryName IS NULL THEN DJUH.MailAddress   END END AS NounyuusakiMailAddress    
          ,CASE WHEN DJUD.DirectFlg = 0 THEN NULL WHEN DJUD.DirectFlg = 1 THEN CASE WHEN DDEP.DeliveryName IS NOT NULL THEN DDEP.DeliveryTelphoneNO  WHEN DDEP.DeliveryName IS NULL THEN DJUH.DeliveryTel11 + ' ' + DJUH.DeliveryTel12 + ' '+ DJUH.DeliveryTel13 END END AS NounyuusakiTELNO    
          ,CASE WHEN DJUD.DirectFlg = 0 THEN NULL WHEN DJUD.DirectFlg = 1 THEN CASE WHEN DDEP.DeliveryName IS NOT NULL THEN DDEP.DeliveryFaxNO       WHEN DDEP.DeliveryName IS NULL THEN DJUH.DeliveryTel21 + ' ' + DJUH.DeliveryTel22 + ' '+ DJUH.DeliveryTel23 END END AS NounyuusakiFAXNO  
          ,DJUD.JuchuuNO    
          ,DJUD.JuchuuRows    
          ,DJUD.AdminNO    
          ,MSKU.SKUCD    
          ...
          --,FORMAT(DJUD.DesiredDeliveryDate,'yyyy/MM/dd') AS KibouNouki --old code
		  --HET from myanmar(TaskNo 2963 )
		  ,CASE WHEN DJUD.DesiredDeliveryDate >= GETDATE() THEN FORMAT(DJUD.DesiredDeliveryDate,'yyyy/MM/dd') 
		   WHEN DJUD.DesiredDeliveryDate < GETDATE() THEN CONVERT(varchar,GETDATE(),111) END AS KibouNouki
          ...
          ,FORMAT(SUB_Hacchuugaku.Value,'###,###') AS Hacchuugaku  */--old code
          --HET TaskNo3105
          ,FORMAT(ISNULL(SUB_HacchuuTanka.Value,0),'N0') AS HacchuuTanka 
		  ,FORMAT(ISNULL(SUB_Hacchuugaku.Value,0),'N0') AS Hacchuugaku 
