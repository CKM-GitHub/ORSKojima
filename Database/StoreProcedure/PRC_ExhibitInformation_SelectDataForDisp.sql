...
BEGIN
	...
	DECLARE 
			  @SSql				nvarchar(MAX)
			, @SSql1			nvarchar(MAX)
			, @CommentItemName	varchar(1000)			-- è§ïiñº
			, @CommentItemCode	varchar(1000)			-- è§ïiî‘çÜ
			, @AddFlg			bit
	...
	--Åyëeóòó¶ÅEäÑà¯ó¶à»äOÇÃèåèÇ≈ÉfÅ[É^ÇíäèoÅz
	...
	--ÅyîÃîÑâøäiÇéÊìæÇµÇƒtmpÇ…UPDATEÅz
	SELECT
	...
	-- ëeóòó¶ = (îÃîÑâøäi - å¥âø) / îÃîÑâøäi
	-- äÑà¯ó¶ = (íËâø - îÃîÑâøäi) / íËâø
	...
	--Åyëeóòó¶/äÑà¯ó¶Ç™éwíËÇ≥ÇÍÇΩèÍçáÅAïsóvÉfÅ[É^ÇçÌèúÇ∑ÇÈÅz
	-- ëeóòó¶ (âÊñ Ç≈éwíËÇ≥ÇÍÇΩêîílà»è„ÇÃílÇÕçÌèú)
	...
	-- äÑà¯ó¶ (âÊñ Ç≈éwíËÇ≥ÇÍÇΩêîílñ¢ñûÇÃílÇÕçÌèú)
