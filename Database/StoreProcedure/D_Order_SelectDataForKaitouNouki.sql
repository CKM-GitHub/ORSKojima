...
BEGIN
    ...
    SELECT DH.OrderNO
          ...
          ,CASE DH.DestinationKBN WHEN 1 THEN (SELECT soukoCD FROM F_Souko(CONVERT(DATETIME, GETDATE())) WHERE StoreCD = DH.StoreCD and SoukoType = 3 ) ELSE dh.DestinationSoukoCD END AS DestinationSoukoCD
          ,DM.ColorName
          ,DM.SizeName
