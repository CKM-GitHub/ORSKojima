...
namespace DL
{
    ...
    public class TempoRegiRyousyuusyo_DL : Base_DL
    {
        ...
        public DataTable D_ReceiptSelectData( string salesNO = "", string StoreCD = "")
        {
        ...
        //Added by SES
        public DataTable D_RyousyuusyoPrintSelectData(string printdate = "", string amountofmoney = "", string OperatorCD = "")
        {
            string sp = "D_SelectData_ForTempoRegiRyousyuusyo2";

            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
            {
                { "@PrintDate", new ValuePair { value1 = SqlDbType.VarChar, value2 = printdate } },
                { "@SalesGaku", new ValuePair { value1 = SqlDbType.VarChar, value2 = amountofmoney } },
                { "@StaffCD", new ValuePair { value1 = SqlDbType.VarChar, value2 = OperatorCD} },
            };
