...
namespace DL
{
    public class M_ITEM_DL : Base_DL
    {
        ...
        public DataTable M_ITEM_CheckExistsByItemCD(M_ITEM_Entity me)
        {
            string sp = "M_ITEM_CheckExistsByItemCD";
 ...
 //           @xml as xml
	...
	//,@MainFlg as tinyint
        ...
        public bool M_ITEM_Exec(M_ITEM_Entity me, DataTable dt, DataTable dtSite, short operationMode)
        {
            ...
            AddParam(command, "@ColorCount", SqlDbType.TinyInt, me.ColorNO);
            AddParam(command, "@SizeCount", SqlDbType.TinyInt, me.SizeNO);
            ...
            AddParam(command, "@TagName01", SqlDbType.VarChar, me.TagName1);
            AddParam(command, "@TagName02", SqlDbType.VarChar, me.TagName2);
            AddParam(command, "@TagName03", SqlDbType.VarChar, me.TagName3);
            AddParam(command, "@TagName04", SqlDbType.VarChar, me.TagName4);
            AddParam(command, "@TagName05", SqlDbType.VarChar, me.TagName5);
            AddParam(command, "@TagName06", SqlDbType.VarChar, me.TagName6);
            AddParam(command, "@TagName07", SqlDbType.VarChar, me.TagName7);
            AddParam(command, "@TagName08", SqlDbType.VarChar, me.TagName8);
            AddParam(command, "@TagName09", SqlDbType.VarChar, me.TagName9);
            AddParam(command, "@TagName101", SqlDbType.VarChar, me.TagName10);
