...
namespace DL
{
    public class M_Souko_DL : Base_DL
    {
        ...
        public DataTable M_Souko_BindForZaiko()
        {
            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
            {
            };
            return SelectData(dic, "M_Souko_BindForZaiko");
        }
        ...
        // チェックシートNo 3081, 3083
        public DataTable M_Souko_BindForTanaban(M_Souko_Entity mse)
        {
            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
            {
                { "@StoreCD", new ValuePair { value1 = SqlDbType.VarChar, value2 = mse.StoreCD } },
            ...
            return SelectData(dic, "M_Souko_SelectForTanaban");
        }

        public DataTable M_Souko_BindForHacchuuNyuuryoku(M_Souko_Entity mse)
        {
            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
            {
                { "@StoreCD", new ValuePair { value1 = SqlDbType.VarChar, value2 = mse.StoreCD } },
            ...
            return SelectData(dic, "M_Souko_BindForHacchuuNyuuryoku");
        }
        public DataTable M_Souko_BindForStoreMainSouko(M_Souko_Entity mse)
        {
            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
            {
                { "@StoreCD", new ValuePair { value1 = SqlDbType.VarChar, value2 = mse.StoreCD } },
            ...
            return SelectData(dic, "M_Souko_BindForStoreMainSouko");
        }

        public DataTable M_Souko_Check(M_Souko_Entity mse)
        {
            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
            {
                { "@StoreCD", new ValuePair { value1 = SqlDbType.VarChar, value2 = mse.StoreCD } },
            ...
            return SelectData(dic, "M_Souko_Check");
        }
    }
}