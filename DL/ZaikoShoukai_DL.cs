...
namespace DL
{
   public class ZaikoShoukai_DL : Base_DL
    {
        //M_ItemSelectOutput
        public DataTable M_ItemSelectOutput(M_SKU_Entity msku_entity, M_SKUInfo_Entity msInfo_entity, M_SKUTag_Entity msTag, int Type, int chktype, int chkUnapprove)
        {
            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
            {
               ...
               { "@UpdateDateTimeF", new ValuePair { value1 = SqlDbType.Date, value2 = msku_entity.UpdateDateFrom } },
               { "@UpdateDateTimeT", new ValuePair { value1 = SqlDbType.Date, value2 = msku_entity.UpdateDateTo } },
               ...
               { "@OrOrAnd", new ValuePair { value1 = SqlDbType.TinyInt, value2 = msku_entity.OrOrAnd } },
            };
            return SelectData(dic, "M_ItemSelectOutput");
        }
        public DataTable M_ItemSelectOutput_SKUPrice(M_SKU_Entity msku_entity, M_SKUInfo_Entity msInfo_entity, M_SKUTag_Entity msTag, D_Stock_Entity ds_Entity, int Type, int chktype, int chkUnapprove,int andor)
        {
            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
            {
               ...
               { "@KeyItem", new ValuePair { value1 = SqlDbType.VarChar, value2 =  msTag.CheckInfo} },
               //{ "@andOr", new ValuePair { value1 = SqlDbType.VarChar, value2 =  andor.ToString()} },
        ...
        public DataTable ZaikoShoukai_Search(M_SKU_Entity msku_entity,M_SKUInfo_Entity msInfo_entity,M_SKUTag_Entity msTag, D_Stock_Entity ds_Entity,int Type,int chktype,int chkUnapprove)
        {
            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
            {
               ...
               { "@OrOrAnd", new ValuePair { value1 = SqlDbType.VarChar, value2 = msku_entity.OrOrAnd} },
            };
