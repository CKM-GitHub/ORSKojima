...
namespace DL
{
    public class M_DenominationKBN_DL : Base_DL 
    {
        ...
        public DataTable M_DenominationKBN_Selectkbn(string SystemKBN)
        {
            string sp = "M_DenominationKBN_SelectKBN";
            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
            {
                { "@denominationCD", new ValuePair { value1 = SqlDbType.TinyInt, value2 = SystemKBN} }
            };
            return SelectData(dic, sp);
        }
