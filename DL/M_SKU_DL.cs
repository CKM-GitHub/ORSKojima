...
namespace DL
{
    public class M_SKU_DL : Base_DL
    {
        ...
        public DataTable M_SKU_SelectForSearchProduct(M_SKU_Entity mse, M_SKUInfo_Entity msie)
        {
            ...
            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
                {
                  //  { "@Sign", new ValuePair { value1 = SqlDbType.VarChar, value2 = "〇" } }, 
        ...
        public DataTable M_SKU_SelectAll_FORSKU()
        {
            string sp = "M_SKU_SelectAll_FORSKU";
            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
            {
            };
            return SelectData(dic, sp);
        ...
        public DataTable M_SKU_Export(M_SKU_Entity ms,int checkflg,int chkUnapprove, int mode,int type)
        {
            ...
            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
           {
               ...
               //{"@keyword1",new ValuePair { value1=SqlDbType.VarChar,value2=ms.Keyword1} },
               //{"@keyword2",new ValuePair { value1=SqlDbType.VarChar,value2=ms.Keyword2} },
               //{"@keyword3",new ValuePair { value1=SqlDbType.Int,value2=ms.Keyword3} },
        ...
        public DataTable M_SKUPrice_Export(M_SKU_Entity ms, int chkUnapprove, int mode)
        {
            ...
            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
           {
               ...
               { "@InsertDateTimeT", new ValuePair { value1 = SqlDbType.Date, value2 = ms.InputDateTo } },
               { "@InsertDateTimeF", new ValuePair { value1 = SqlDbType.Date, value2 = ms.InputDateFrom } },
               { "@UpdateDateTimeF", new ValuePair { value1 = SqlDbType.Date, value2 = ms.UpdateDateFrom } },
               { "@UpdateDateTimeT", new ValuePair { value1 = SqlDbType.Date, value2 = ms.UpdateDateTo } },
               { "@ApprovalDateF", new ValuePair { value1 = SqlDbType.Date, value2 = ms.ApprovalDateFrom } },
               { "@ApprovalDateT", new ValuePair { value1 = SqlDbType.Date, value2 = ms.ApprovalDateTo} },
               { "@YearTerm", new ValuePair { value1 = SqlDbType.VarChar, value2 = ms.LastYearTerm } },
               { "@Season", new ValuePair { value1 = SqlDbType.VarChar, value2 = ms.LastSeason } },
               ...
               { "@PC", new ValuePair { value1 = SqlDbType.VarChar, value2 = ms.PC} },
               { "@KeyItem", new ValuePair { value1 = SqlDbType.VarChar, value2 = ms.Key} },
               { "@OrOrAnd", new ValuePair { value1 = SqlDbType.TinyInt, value2 = ms.OrOrAnd } },
            };

            return SelectData(dic, sp);
        }

        public DataTable M_SKU_Search(M_SKU_Entity ms, int checkflg, int chkUnapprove, int mode, int type)
        {
            string sp = "M_SKU_Search";
            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
           {
                { "@ChangeDate", new ValuePair { value1 = SqlDbType.Date, value2 =ms.ChangeDate } },
               { "@VendorCD", new ValuePair { value1 = SqlDbType.VarChar, value2 = ms.MainVendorCD } },
