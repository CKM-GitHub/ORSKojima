   ...
   public class M_StorePoint_DL:Base_DL
    {
        ...
        public bool M_StorePoint_Insert_Update(M_StorePoint_Entity mspe)
        {
            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
            {
                ...
                { "@Print1_NoTrim", new ValuePair { value1 = SqlDbType.VarChar, value2 = mspe.Print1 } },
                ...
                { "@Print2_NoTrim", new ValuePair { value1 = SqlDbType.VarChar, value2 = mspe.Print2 } },
                ...
                { "@Print3_NoTrim", new ValuePair { value1 = SqlDbType.VarChar, value2 = mspe.Print3 } },
                ...
                { "@Print4_NoTrim", new ValuePair { value1 = SqlDbType.VarChar, value2 = mspe.Print4 } },
                ...
                { "@Print5_NoTrim", new ValuePair { value1 = SqlDbType.VarChar, value2 = mspe.Print5 } },
                ...
                { "@Print6_NoTrim", new ValuePair { value1 = SqlDbType.VarChar, value2 = mspe.Print6 } },
                ...
                { "@Print7_NoTrim", new ValuePair { value1 = SqlDbType.VarChar, value2 = mspe.Print7 } },
                ...
                { "@Print8_NoTrim", new ValuePair { value1 = SqlDbType.VarChar, value2 = mspe.Print8 } },
                ...
                { "@Print9_NoTrim", new ValuePair { value1 = SqlDbType.VarChar, value2 = mspe.Print9 } },
                ...
                { "@Print10_NoTrim", new ValuePair { value1 = SqlDbType.VarChar, value2 = mspe.Print10 } },
                ...
                { "@Print11_NoTrim", new ValuePair { value1 = SqlDbType.VarChar, value2 = mspe.Print11 } },
                ...
                { "@Print12_NoTrim", new ValuePair { value1 = SqlDbType.VarChar, value2 = mspe.Print12 } },
        ...
        public DataTable M_StorePoint_ExpirationDate(String StoreCD)
        {
            string sp = "M_StorePoint_ExpirationDate";          
            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
            {
