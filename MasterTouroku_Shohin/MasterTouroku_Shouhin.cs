    ...
    internal partial class MasterTouroku_Shouhin : FrmMainForm
    {
        ...
        private void MasterTouroku_Shouhin_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                mFractionKBN = mste.FractionKBN.ToInt16(0);
        ...
        private void InitialControlArray()
        {
            ...
            detailControls = new Control[] {ckM_CheckBox19,ckM_CheckBox20,ckM_CheckBox21,ckM_CheckBox22,
                ...
                ScTani.TxtCode,ckM_CheckBox1,ckM_CheckBox2,ckM_CheckBox3,ckM_CheckBox4,
                ckM_CheckBox5,ckM_CheckBox6,ckM_CheckBox7,ckM_CheckBox8,ckM_CheckBox9,
                ckM_CheckBox10,ckM_CheckBox11,ckM_CheckBox12,ckM_CheckBox13,ckM_CheckBox14,
                ckM_CheckBox15,ckM_CheckBox16,ckM_CheckBox17,ckM_CheckBox18,ckM_CheckBox23,
                ckM_CheckBox24,ckM_CheckBox25,ckM_CheckBox26,ckM_CheckBox27,ckM_CheckBox28
                , ScBrand.TxtCode, ScSegmentCD.TxtCode, ScSports.TxtCode, ScVendor.TxtCode, ScRackNo.TxtCode
                ,ckM_ComboBox1,ckM_ComboBox2,ckM_ComboBox3,ckM_ComboBox4,ckM_ComboBox5,
                cmbTaxRateFLG,cmbCostingKBN, ckM_TextBox18, ckM_TextBox17, ckM_TextBox8,
                ckM_TextBox9, ckM_TextBox5, ckM_TextBox11, ckM_TextBox10,cmbOrderAttentionCD,
                
                ckM_TextBox13 ,
                CmbTag1,CmbTag2, CmbTag3, CmbTag4,
                CmbTag5, CmbTag6 , CmbTag7 , CmbTag8 , CmbTag9 ,
                CmbTag10,
                ScExhibitionSegmentCD.TxtCode, txtOrderLot, CmbLastYearTerm, CmbLastSeason,
                ckM_TextBox22, ckM_TextBox23,TxtRemark, ckM_TextBox3, ckM_MultiLineTextBox1,ckM_MultiLineTextBox2,
                ckM_MultiLineTextBox3,ckM_MultiLineTextBox4, ckM_TextBox2, ckM_TextBox1,ckM_TextBox16,
                checkDeleteFlg
            };
        ...
        /// <returns></returns>
        private bool CheckKey(int index, short kbn = 0, bool set = true, bool allCheck = false)
        {
            if (kbn == 0)
            {
                switch (index)
            ...
            else
            {
                ...
                switch (index)
                {
                    ...
                    case (int)EIndex.ChangeDate:
                        if (!CheckKey((int)EIndex.ItemCD, 0, true, true))
                        {
                            keyControls[(int)EIndex.ItemCD].Focus();
                            return false;
                        }
                        if (!CheckKey(index, 0, true, true))
                        {
            ...
            if (index == (int)EIndex.ChangeDate)
            {
                ...
                if (OperationMode == EOperationMode.INSERT && kbn == 0)
                {
                    ...
                    if (!allCheck)
                    {
                        if (mibl.M_ITEM_CheckExistsByItemCD(keyControls[(int)EIndex.ItemCD].Text))
                        {
                            //過去に登録のあるITEMです。複写機能で過去データを呼び出してメンテしてください。
                            bbl.ShowMessage("I321");
                        }
                    }
                    if (set)
                    {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            int colNo = row["SizeNO"].ToInt32(0);//Size
                            int rowNo = row["ColorNO"].ToInt32(0);//Color
                            ...
                            if(kbn.Equals(1))
                            {
                                ...
                                //改定時はAdminNOを残し、以外はAdminNOは振りなおす
                                if (keyControls[(int)EIndex.ItemCD].Text != copyKeyControls[(int)EIndex.ItemCD].Text)
                                {
                                    row["AdminNO"] = 0;
                                }
                        ...
                        //if(kbn.Equals(0)) // closed by ETZ for taskNO 2993
                        detailControls[(int)EIndex.MakerItem].Text = mie.MakerItem;
                        //else                                                              // closed by ETZ for taskNO 2993
                        //    detailControls[(int)EIndex.MakerItem].Text = mie.ITemCD;
                        ...
                        CheckDetail((int)EIndex.ExhibitionSegmentCD);
                       ...
                       ((ComboBox) detailControls[(int)EIndex.CmbTaxRateFLG]).SelectedValue = mie.TaxRateFLG;
                        ...
                        detailControls[(int)EIndex.CmbTag1].Text= mie.TagName1;
                        detailControls[(int)EIndex.CmbTag2].Text= mie.TagName2;
                        detailControls[(int)EIndex.CmbTag3].Text= mie.TagName3;
                        detailControls[(int)EIndex.CmbTag4].Text= mie.TagName4;
                        detailControls[(int)EIndex.CmbTag5].Text= mie.TagName5;
                        detailControls[(int)EIndex.CmbTag6].Text= mie.TagName6;
                        detailControls[(int)EIndex.CmbTag7].Text= mie.TagName7;
                        detailControls[(int)EIndex.CmbTag8].Text= mie.TagName8;
                        detailControls[(int)EIndex.CmbTag9].Text= mie.TagName9;
                        detailControls[(int)EIndex.CmbTag10].Text = mie.TagName10;
        ...
        private void InitGrid()
        {
            ...
            int colorNo = detailControls[(int)EIndex.ColorNO].Text.ToInt16(0);
            int sizeNo = detailControls[(int)EIndex.SizeNO].Text.ToInt16(0);
            ...
            switch (index)
            {
                ...
                case (int)EIndex.PriceOutTax: //税抜定価
                    ...
                    if (mOldPriceOutTax != bbl.Z_Set(detailControls[index].Text))
                    {
                        ...
                        decimal zeiritsu = 0;
                        int taxRate = 0;
                        if(cmbTaxRateFLG.SelectedValue != null && cmbTaxRateFLG.SelectedValue.ToInt16(0) >= 0)
                        {
                            taxRate = cmbTaxRateFLG.SelectedValue.ToInt16(0);
                        }
                ...
                case (int)EIndex.OrderPriceWithoutTax://税抜発注額
                    ...
                    if (mOldOrderPriceWithoutTax != bbl.Z_Set(detailControls[index].Text)) 
                    {
                        ...
                        if(!string.IsNullOrWhiteSpace(detailControls[(int)EIndex.Rate].Text))
                            detailControls[(int)EIndex.OrderPriceWithoutTax].Text = bbl.Z_SetStr(GetResultWithHasuKbn(mFractionKBN, bbl.Z_Set(detailControls[(int)EIndex.PriceOutTax].Text) * bbl.Z_Set(detailControls[(int)EIndex.Rate].Text) / 100));
                        //税込発注額＝税抜発注額×（１＋（税率÷100））								
                        detailControls[(int)EIndex.OrderPriceWithTax].Text = bbl.Z_SetStr(bbl.GetZeikomiKingaku(bbl.Z_Set(detailControls[(int)EIndex.OrderPriceWithoutTax].Text), taxRate, out zei));
                    }
        ...
        private M_ITEM_Entity GetEntity(short kbn, short key = 0)
        {
            ...
            mie.CostingKBN = ((ComboBox)detailControls[(int)EIndex.CmbCostingKBN]).SelectedValue.ToStringOrNull();
        ...
        protected override void ExecSec()
        {
            for (int i = 0; i <= (int)EIndex.ChangeDate; i++)
                ...
                {
                    if (CheckKey(i, 0, false, true) == false)
                    {
                        keyControls[i].Focus();
                        return;
                    }
        ...
        private void btnJanCount_Click(object sender, EventArgs e)
        {
            try
            {
                //カラー、サイズの未入力チェックも必要
                ...
                //JANDCの入力が無いセルが存在する場合
                //①採番可否の判断（他の画面で自動採番中であればエラーにする）
                //M_JANCounterを	MainKEY＝2でSelect	
                M_JANCounter_Entity me = new M_JANCounter_Entity();
                me.MainKEY = "2";
                bool ret = mibl.M_JANCounter_Select(me);
        ...
        private void SetDataToNewRow(int columnIndex, int rowIndex, string jancd)
        {
            ...
            newrow["ChangeDate"] = keyControls[(int)EIndex.ChangeDate].Text;
            ...
            newrow["MakerVendorCD"] = detailControls[(int)EIndex.MainVendorCD].Text;
            ...
            newrow["OrderLot"] =detailControls[(int)EIndex.OrderLot].Text=="" ? "1" : detailControls[(int)EIndex.OrderLot].Text;  //Changed by ETZ for task 2872
        ...
        private DataTable Set_SiteData()
        {
            DataTable dttemp = new DataTable();
            DataTable dtNewSKU = new DataTable();
            dttemp = dtSite.Copy();
            for (int i = 0; i < dtSKU.Rows.Count; i++)
            {
                DataRow[] rows = dtSite.Select("SizeNO = " + dtSKU.Rows[i]["SizeNO"].ToString() + " AND ColorNO = " + dtSKU.Rows[i]["ColorNO"].ToString());
                if (rows.Length.Equals(0) && dtNewSKU.Rows.Count==0)
                {
                    for (int j = 0; j < dtSite.Rows.Count; j++)
                    {
                        DataRow dtrow = dttemp.NewRow();
                        dtrow["ChangeDate"]= dtSKU.Rows[i]["ChangeDate"].ToString();
                        dtrow["SizeNO"] = dtSKU.Rows[i]["SizeNO"].ToString();
                        dtrow["ColorNO"] = dtSKU.Rows[i]["ColorNO"].ToString();
                        dtrow["StoreCD"] = dtSite.Rows[j]["StoreCD"].ToString();
                        dtrow["StoreName"] = dtSite.Rows[j]["StoreName"].ToString();
                        dtrow["APIKey"] = dtSite.Rows[j]["APIKey"].ToString();
                        dtrow["ShouhinCD"] = keyControls[(int)EIndex.ItemCD].Text;
                        dtrow["SiteURL"] = dtSite.Rows[i]["SiteURL"].ToString();

                        dttemp.Rows.Add(dtrow);
                    }

                }
                else if(rows.Length.Equals(0) && dtNewSKU.Rows.Count > 0)
                {
                    for (int j = 0; j < dtNewSKU.Rows.Count; j++)
                    {
                        DataRow dtrow = dttemp.NewRow();
                        dtrow["ChangeDate"] = dtNewSKU.Rows[i]["ChangeDate"].ToString();
                        dtrow["SizeNO"] = dtSKU.Rows[i]["SizeNO"].ToString();
                        dtrow["ColorNO"] = dtSKU.Rows[i]["ColorNO"].ToString();
                        dtrow["StoreCD"] = dtNewSKU.Rows[j]["StoreCD"].ToString();
                        dtrow["StoreName"] = dtNewSKU.Rows[j]["StoreName"].ToString();
                        dtrow["APIKey"] = dtNewSKU.Rows[j]["APIKey"].ToString();
                        dtrow["ShouhinCD"] = keyControls[(int)EIndex.ItemCD].Text;
                        dtrow["SiteURL"] = dtNewSKU.Rows[i]["SiteURL"].ToString();
                ...
                {
                    dtNewSKU = dtSite.Select("SizeNO = " + dtSKU.Rows[0]["SizeNO"].ToString() + " AND ColorNO = " + dtSKU.Rows[0]["ColorNO"].ToString()).CopyToDataTable();
                }
