...
/// <returns></returns>
        ...
        {
            return mdl.M_SKU_SelectAll_FORSKU();
        }

        public DataTable M_SKU_Export(M_SKU_Entity me,int checkflg, int chkUnapprove,int mode,int type)
        {
            return mdl.M_SKU_Export(me, checkflg, chkUnapprove,mode,type);
        }
        ...
        public DataTable M_SKU_Search(M_SKU_Entity me, int checkflg, int chkUnapprove, int mode, int type)
        {
            return mdl.M_SKU_Search(me, checkflg, chkUnapprove, mode, type);
        }
    }
}
