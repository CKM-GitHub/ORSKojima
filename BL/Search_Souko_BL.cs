...
namespace BL
{
    public class Search_Souko_BL : Base_BL
    {
        ...
        {
            return msoukodl.M_Souko_BindForZaiko();
        }
        ...
        {
            return msoukodl.M_Souko_BindForTanaban(mse);
        }
        public DataTable M_Souko_BindForHacchuuNyuuryoku(M_Souko_Entity mse)
        {
            return msoukodl.M_Souko_BindForHacchuuNyuuryoku(mse);
        }
        public DataTable M_Souko_BindForStoreMainSouko(M_Souko_Entity mse)
        {
            return msoukodl.M_Souko_BindForStoreMainSouko(mse);
        }
    }
}
