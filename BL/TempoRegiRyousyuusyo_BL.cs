...
namespace BL
{
    ...
    public class TempoRegiRyousyuusyo_BL : Base_BL
    {
        ...
        public DataTable D_ReceiptSelect(string salesNo = "", string StoreCD ="" )
        {
            TempoRegiRyousyuusyo_DL dl = new TempoRegiRyousyuusyo_DL();
            return dl.D_ReceiptSelectData(salesNo,StoreCD);
        }
        //AddedBySES
        public DataTable D_RyousyuusyoPrintSelect(string printdate = "", string amountofmoney = "", string OperatorCD = "")
        {
            TempoRegiRyousyuusyo_DL dl = new TempoRegiRyousyuusyo_DL();
            return dl.D_RyousyuusyoPrintSelectData(printdate, amountofmoney, OperatorCD);
        }
