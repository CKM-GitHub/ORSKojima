    ...
    public partial class TempoRegiKaiinKensaku : ShopBaseForm
    {
        ...
        private void ShowDetail()
        {
            Customer = GetCustomer();
            {
                ...
                {
                    dgvKaniiKensaku.DataSource = null;
        ...
        {
            if(dgvKaniiKensaku.Rows.Count > 0)
            {
        ...
        {
            if (string.IsNullOrWhiteSpace(txtZipCD.Text) && string.IsNullOrWhiteSpace(txtDBO.Text) && string.IsNullOrWhiteSpace(txtCustomerCD.Text)
                && string.IsNullOrWhiteSpace(txtKanaName.Text) && string.IsNullOrWhiteSpace(txtCustomerName.Text))
            {
        ...
        private void dgvKaniiKensaku_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
