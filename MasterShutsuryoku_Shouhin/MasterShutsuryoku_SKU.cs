...
namespace MasterShutsuryoku_Shouhin
{
    ...
    public partial class MasterShutsuryoku_Shouhin : FrmMainForm
    {
        ...
        private void MasterShutsuryoku_Shouhin_Load(object sender, EventArgs e)
        {
            ...
            AddCol();
            this.CB_Tag1.AcceptKey = true;
            this.CB_Tag2.AcceptKey = true;
            this.CB_Tag3.AcceptKey = true;
            this.CB_Tag4.AcceptKey = true;
            this.CB_Tag5.AcceptKey = true;
        }
        ...
        private void CleanData()
        {
            ...
            dtData.Clear();
            GV_SKU.FirstDisplayedScrollingColumnIndex = 5;
        ...
        {
            //string[] strlist = TB_CommentInStore.Text.Split(',');
        ...
        private void OutputExecel()
        {
            ...
            if (ErrorCheck())
            {
                ...
                {
                    mode = (CK_suru.Checked && RB_Item.Checked) ? 1 : (CK_suru.Checked == true && RB_Item.Checked == true) ? 2 : 3;
                    ...
                    dt = mbl.M_SKU_Export(msku, checkflg, chkUnapprove, mode,type);
                    if (dt.Rows.Count > 0)
                    {
                        if (checkflg != 1)
                        {
                        ...
                        DataTable dtnew = dt;
                        string folderPath = "C:\\SMS\\MasterShutsuryoku_SKU\\";
        ...
        private void AddCol()
        {
            if (dtData.Columns.Count == 0)
            {
                ...
                dtData.Columns.Add("カラー名");
                dtData.Columns.Add("サイズ名");
                dtData.Columns.Add("データ区分");
                dtData.Columns.Add("AdminNO");
                dtData.Columns.Add("改定日");
                dtData.Columns.Add("承認日");
                dtData.Columns.Add("JANCD");
                dtData.Columns.Add("削除");
                //11
                dtData.Columns.Add("諸口区分");
                dtData.Columns.Add("カナ名");
                dtData.Columns.Add("略名");
                dtData.Columns.Add("英語名");
                dtData.Columns.Add("ITEMCD");
                dtData.Columns.Add("サイズ枝番");
                dtData.Columns.Add("カラー枝番");
                dtData.Columns.Add("主要仕入先CD");
                dtData.Columns.Add("主要仕入先名");
                //dtData.Columns.Add("メーカー仕入先CD");
                //dtData.Columns.Add("メーカー仕入先名");
                dtData.Columns.Add("ブランドCD");
                //21
                dtData.Columns.Add("ブランド名");
                dtData.Columns.Add("メーカー商品CD");
                dtData.Columns.Add("単位CD");
                dtData.Columns.Add("単位名");
                dtData.Columns.Add("競技CD");
                dtData.Columns.Add("競技名");
                dtData.Columns.Add("商品分類CD");
                dtData.Columns.Add("分類名");
                dtData.Columns.Add("セグメントCD");
                dtData.Columns.Add("セグメント名");
                //31
                dtData.Columns.Add("セット品区分");
                dtData.Columns.Add("セット品区分名");
                dtData.Columns.Add("プレゼント品区分");
                dtData.Columns.Add("プレゼント品区分名");
                dtData.Columns.Add("サンプル品区分");
                dtData.Columns.Add("サンプル品区分名");
                dtData.Columns.Add("値引商品区分");
                dtData.Columns.Add("値引商品区分名");
                dtData.Columns.Add("Webストア取扱区分");
                dtData.Columns.Add("Webストア取扱区分名");
                //41
                dtData.Columns.Add("実店舗取扱区分");
                dtData.Columns.Add("実店舗取扱区分名");
                dtData.Columns.Add("在庫管理対象区分");
                dtData.Columns.Add("在庫管理対象区分名");
                dtData.Columns.Add("架空商品区分");
                dtData.Columns.Add("架空商品区分名");
                dtData.Columns.Add("直送品区分");
                dtData.Columns.Add("直送品区分名");
                dtData.Columns.Add("予約品区分");
                dtData.Columns.Add("予約品区分名");
                //51
                dtData.Columns.Add("特記区分");
                dtData.Columns.Add("特記区分名");
                dtData.Columns.Add("送料区分");
                dtData.Columns.Add("送料区分名");
                dtData.Columns.Add("要加工品区分");
                dtData.Columns.Add("要加工品区分名");
                dtData.Columns.Add("要確認品区分");
                dtData.Columns.Add("要確認品区分名");
                dtData.Columns.Add("Web在庫連携区分");
                dtData.Columns.Add("Web在庫連携区分名");
                //61
                dtData.Columns.Add("販売停止品区分");
                dtData.Columns.Add("販売停止品区分名");
                dtData.Columns.Add("廃盤品区分");
                dtData.Columns.Add("廃盤品区分名");
                dtData.Columns.Add("完売品区分");
                dtData.Columns.Add("完売品区分名");
                dtData.Columns.Add("自社在庫連携区分");
                dtData.Columns.Add("自社在庫連携区分名");
                dtData.Columns.Add("メーカー在庫連携対象");
                dtData.Columns.Add("メーカー在庫連携対象名");
                //71
                dtData.Columns.Add("店舗在庫連携対象");
                dtData.Columns.Add("店舗在庫連携対象名");
                dtData.Columns.Add("Net発注不可区分");
                dtData.Columns.Add("Net発注不可区分名");
                dtData.Columns.Add("EDI発注可能区分");
                dtData.Columns.Add("EDI発注可能区分名");
                dtData.Columns.Add("自動発注対象区分");
                dtData.Columns.Add("自動発注対象");
                dtData.Columns.Add("カタログ掲載有無区分");
                dtData.Columns.Add("カタログ掲載有無");
                //81
                dtData.Columns.Add("小包梱包可能区分");
                dtData.Columns.Add("小包梱包可能");
                dtData.Columns.Add("税率区分");
                dtData.Columns.Add("税率区分名");
                dtData.Columns.Add("原価計算方法");
                dtData.Columns.Add("原価計算方法名");
                dtData.Columns.Add("Sale対象外区分");
                dtData.Columns.Add("Sale対象外区分名");
                dtData.Columns.Add("標準原価");
                dtData.Columns.Add("税抜定価");
                //91
                dtData.Columns.Add("税込定価");
                dtData.Columns.Add("発注税込価格");
                dtData.Columns.Add("発注税抜価格");
                dtData.Columns.Add("掛率");
                dtData.Columns.Add("発売開始日");
                dtData.Columns.Add("Web掲載開始日");
                dtData.Columns.Add("発注注意区分");
                dtData.Columns.Add("発注注意区分名");
                dtData.Columns.Add("発注注意事項");
                dtData.Columns.Add("管理用備考");
                //101
                dtData.Columns.Add("表示用備考");
                dtData.Columns.Add("棚番");
                dtData.Columns.Add("年度");
                dtData.Columns.Add("シーズン");
                dtData.Columns.Add("カタログ番号");
                dtData.Columns.Add("カタログページ");
                dtData.Columns.Add("カタログ番号Long");
                dtData.Columns.Add("カタログページLong");
                dtData.Columns.Add("カタログ情報");
                dtData.Columns.Add("指示書番号");
                //111
                dtData.Columns.Add("指示書発行日");
                dtData.Columns.Add("商品情報アドレス");
                dtData.Columns.Add("構成数");
                dtData.Columns.Add("発注ロット");
                dtData.Columns.Add("タグ１");
                dtData.Columns.Add("タグ２");
                dtData.Columns.Add("タグ３");
                dtData.Columns.Add("タグ４");
                dtData.Columns.Add("タグ５");
                dtData.Columns.Add("タグ６");
                //121
                dtData.Columns.Add("タグ７");
                dtData.Columns.Add("タグ８");
                dtData.Columns.Add("タグ９");
                dtData.Columns.Add("タグ１０");
            }
        }
        ...
        private void F11()
        {
            if (ErrorCheck())
            {
                ...
                dtData = mbl.M_SKU_Search(msku, checkflg, chkUnapprove, mode, type);

                if (dtData.Rows.Count > 0)
                {
                    GV_SKU.Refresh();
                    GV_SKU.DataSource = dtData;
                }
                else
                {
                    GV_SKU.DataSource = null;
        ...
        private void RB_all_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                //「全て」選択時のみ「F11」押下可能
                ckM_BT_hyoji.Enabled = RB_all.Checked;
                Btn_F11.Enabled = RB_all.Checked;
            }
            catch (Exception ex)
            {
                //エラー時共通処理
