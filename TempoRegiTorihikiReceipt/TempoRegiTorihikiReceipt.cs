...
namespace TempoRegiTorihikiReceipt
{
    public partial class TempoRegiTorihikiReceipt : ShopBaseForm
    {
        ...
        private void TempoRegiTorihikiReceipt_Load(object sender, EventArgs e)
        {
            ...
            //string[] cmds = new string[] { "C:\\", "01", "0001", "MYA040_PC", "2", "3832" };
            // 
            //01 0001 MYA040_PC 2 3832
                ...
                switch (InputMode)
                {
                        ...
                        try
                        {
                            ...
                            if (torihikiReceiptDataSet.MiscDepositTable.Rows.Count > 0 && torihikiReceiptDataSet.DepositTable.Rows.Count == 0)
                            {
                                ...
                                if (msg == "devMode")
                                {
                                    ...
                                    vr.CrystalReportViewer1.ReportSource = reportModeDepositMiscDeposit;
                                    vr.ShowDialog();
                                    return;
                                }
                            ...
                            else if (torihikiReceiptDataSet.MiscDepositTable.Rows.Count == 0 && torihikiReceiptDataSet.DepositTable.Rows.Count > 0)
                            {
                                ...
                                {
                                    Base.Client.Viewer vr = new Base.Client.Viewer();
                                    vr.CrystalReportViewer1.ReportSource = reportModeDepositDeposit;
                                    vr.ShowDialog();
                                    return;
                                }
                            ...
                            else if (torihikiReceiptDataSet.MiscDepositTable.Rows.Count > 0 && torihikiReceiptDataSet.DepositTable.Rows.Count > 0)
                            {
                                ...
                                {
                                    Base.Client.Viewer vr = new Base.Client.Viewer();
                                    vr.CrystalReportViewer1.ReportSource = reportModeDeposit;
                                    vr.ShowDialog();
                                    return;
                                }
                    ...
                    case MODE_EXCHANGE:
                        ...
                        if (exchange.Rows.Count > 0)
                        {
                            ...
                            {
                                Base.Client.Viewer vr = new Base.Client.Viewer();
                                vr.CrystalReportViewer1.ReportSource = reportModeExchange;
                                vr.ShowDialog();
                                return;
                            }
                    ...
                    case MODE_CHANGE_PREPARATION:
                        ...
                        if (changePreparation.Rows.Count > 0)
                        {
                            ...
                            {
                                Base.Client.Viewer vr = new Base.Client.Viewer();
                                vr.CrystalReportViewer1.ReportSource = reportModeChangePreparation;
                                vr.ShowDialog();
                                return;
                            }
