...
{ 
    public partial class TennicLogin : Form
    {
        ...
        {
            Process[] localByName = Process.GetProcessesByName("TennicSMS");
        ...
        {
            if (e.Control && e.KeyCode == Keys.Alt && e.KeyCode == Keys.Control && e.KeyCode == Keys.C)
            {
        ...
        private void TennicLogin_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void TennicLogin_FormClosing(object sender, FormClosingEventArgs e)
        {
            Process[] localByName = Process.GetProcessesByName("TennicSMS");
