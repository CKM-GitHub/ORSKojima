    ...
    internal partial class KaitouNoukiTouroku : FrmMainForm
    {
        ...
        private bool CheckDetail(int index, bool set=true)
        {
            ...
            switch (index)
            {
                ...
                case (int)EIndex.ArrivalPlanDate:
                    ...
                    detailControls[index].Text = fmtYmd;
                    detailControls[index + 1].Focus();   //HET
                    break;
                ...
                case (int)EIndex.ArrivalPlanMonth:
                    ...
                    {
                        detailControls[index].Focus();  //HET
                        return false;
                    }
                    detailControls[index].Text = fmtYmd;
                    break;
            ...
            for (int RW = 0; RW <= mGrid.g_MK_Max_Row - 1; RW++)
            {
                ...
                if (string.IsNullOrWhiteSpace(mGrid.g_DArray[RW].OrderNo) == false && mGrid.g_DArray[RW].Update >= 1)
                {
                   ...
                   dt.Rows.Add(seq
                        ...
                        , mGrid.g_DArray[RW].TaniName == "" ? 0 : 1
                    ...
                    foreach (DataRow row in selectedRows)
                    {
                       ...
                       , row["DestinationKBN"].ToString() == "" ? 0 : 1
        ...
        {          
            ...
            try
            {
                ...
                //HET TaskNo3038
                if (!CheckDetail((int)EIndex.ArrivalPlanDate))
                    return;

                if (!CheckDetail((int)EIndex.ArrivalPlanMonth))
                    return;

                if (!CheckDetail((int)EIndex.ArrivalPlanKbn))
                    return;
