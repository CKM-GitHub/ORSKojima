<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CapitalSport.aspx.cs" Inherits="MenuHosting.RunnerGlobe.CapitalSport" %>
...
<table class="table table-striped" style="width: 80%; margin-left: 10%;">
  <thead>
    <tr>
      <th scope="col">#</th>
        <th class="hideCln" scope="col">CapitalSMS</th>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <span class="active"> Capital用のプログラムをダウンロードしますか？</span>  
          ...
          <asp:RadioButton ID="main" runat="server" GroupName="rad" Text="Main" Checked="true"/>
          <span style="padding:50px"></span>
          <asp:RadioButton ID="store" runat="server" GroupName="rad" Text="Store" />
      </div>
    ...
    <input type="password" class="form-control" id="txtPass2"  maxlength="10"  runat="server" style="width: 200px;"/>
           <button type="button"  class="btn btn-primary"  data-dismiss="modal"  runat="server" onserverclick="Trigger2" > はい</button>
      </div>
