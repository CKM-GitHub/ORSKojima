<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Haspo.aspx.cs" Inherits="MenuHosting.RunnerGlobe.Haspo" %>
...
<table class="table table-striped" style="width: 80%; margin-left: 10%;">
  <thead>
    <tr>
      <th scope="col">#</th>
        <th class="hideCln" scope="col">HaspoSMS</th>
  ...
  <div class="modal-dialog">
    ...
    <input type="password" class="form-control" id="txtPass3"  maxlength="10"  runat="server" style="width: 200px;"/>
           <button type="button"  class="btn btn-primary"  data-dismiss="modal"  runat="server" onserverclick="Trigger3" > はい</button>
      </div>
