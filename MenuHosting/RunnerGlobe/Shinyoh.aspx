<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shinyoh.aspx.cs" Inherits="MenuHosting.RunnerGlobe.Shinyoh" %>
...
<table class="table table-striped" style="width: 80%; margin-left: 10%;">
  ...
  <div class="modal-dialog">
    ...
    <input type="password" class="form-control" id="txtPass5"  maxlength="10"  runat="server" style="width: 200px;"/>
           <button type="button"  class="btn btn-primary"  data-dismiss="modal"  runat="server" onserverclick="Trigger5" > はい </button>
      </div>
