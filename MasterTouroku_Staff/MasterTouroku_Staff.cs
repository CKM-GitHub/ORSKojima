    ...
    public partial class frmMasterTouroku_Staff : FrmMainForm
    {
        ...
        private bool DisplayData(CKM_SearchControl sc)
        {
            ...
            if (dtStaff.Rows.Count > 0)
            {
                ...
                if (dtStaff.Rows[0]["BMNCD"].ToString() == "")
                {
                    cboBMNCD.SelectedValue = "-1";
                }
                else
                {
                    cboBMNCD.SelectedValue = dtStaff.Rows[0]["BMNCD"].ToString();
                }
                if (dtStaff.Rows[0]["MenuCD"].ToString() == "")
                {
                ...
                if (dtStaff.Rows[0]["StoreMenuCD"].ToString() == "")
                {
                    cboStoreMenu.SelectedValue = "-1";
                }
                else
                {
                    cboStoreMenu.SelectedValue = dtStaff.Rows[0]["StoreMenuCD"].ToString();
                }
                if (dtStaff.Rows[0]["AuthorizationsCD"].ToString() == "")
                {
                    cboAuthorizations.SelectedValue = "-1";
                }
                else
                {
                    cboAuthorizations.SelectedValue = dtStaff.Rows[0]["AuthorizationsCD"].ToString();
                }
                if (dtStaff.Rows[0]["StoreAuthorizationsCD"].ToString() == "")
                {
                    cboStoreAuthorizations.SelectedValue = "-1";
                }
                else
                {
                    cboStoreAuthorizations.SelectedValue = dtStaff.Rows[0]["StoreAuthorizationsCD"].ToString();
                }
                if (dtStaff.Rows[0]["PositionCD"].ToString() == "")
                {
        ...
        private M_Staff_Entity GetStaffEntity()
        {
            ...
            if (cboBMNCD.SelectedValue.ToString() == "-1")
            {
                staffdata.BMNCD = string.Empty;
            }
            if (cboMenu.SelectedValue.ToString() == "-1")
            {
                staffdata.MenuCD = string.Empty;
            }
            if (cboStoreMenu.SelectedValue.ToString() == "-1")
            {
                staffdata.StoreMenuCD = string.Empty;
            }
            if (cboAuthorizations.SelectedValue.ToString() == "-1")
            {
                staffdata.KengenCD = string.Empty;
            }
            if (cboStoreAuthorizations.SelectedValue.ToString() == "-1")
            {
                staffdata.StoreAuthorizationsCD = string.Empty;
            }
            if (cboPosition.SelectedValue.ToString() == "-1")
            {
                staffdata.PositionCD = string.Empty;
            }
            return staffdata;
        }
        private bool ErrorCheck(int index)
        {
            ...
            else if (index == 12)
            {
                ...
                if (!string.IsNullOrWhiteSpace(ScStore.Code))
                {
                    ...
                    if (dt.Rows[0]["StoreKBN"].ToString() == "1")
                    {
