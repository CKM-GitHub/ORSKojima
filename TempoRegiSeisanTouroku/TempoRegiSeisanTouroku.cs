    ...
    public partial class frmTempoRegiSeisanTouroku : ShopBaseForm
    {
        ...
        public void DisplayData()
        {
            ...
            if (dtdeposit.Rows.Count > 0)
            {
                ...
                //txtReturn.Text = depostiArr[12];//2021/12/15
                txtDepositPaymentTotal.Visible = false;//2021/12/15
                ckmShop_Label41.Visible = false;//2021/12/15
                txtReturn.Visible = false;//2021/12/15
                ckmShop_Label40.Visible = false;//2021/12/15
                //txtDiscount.Text = depostiArr[12];//2021/12/15
                txtDiscount.Visible = false;//2021/12/15
                ckmShop_Label39.Visible = false;//2021/12/15
                //txtCancel.Text = depostiArr[14];//2021/12/15
                txtCancel.Visible = false;//2021/12/15
                ckmShop_Label38.Visible = false;//2021/12/15
            ...
            if(dtsale .Rows.Count > 0)
            {
                ...
                txtPayPay.Text= stringArr[14];
                txtOther.Text = stringArr[15];
        ...
        private void SelectData()
        {
            ...
            dtgaku1 = seisanbl.D_DepositHistory_Gaku_Select(dphe);
            ...
            dtgaku2 = seisanbl.D_DepositHistory_Gaku_Select(dphe);
            ...
            dtgaku3 = seisanbl.D_DepositHistory_Gaku_Select(dphe);
            ...
            dtgaku4 = seisanbl.D_DepositHistory_Gaku_Select(dphe);
            ...
            dtgaku5 = seisanbl.D_DepositHistory_Gaku_Select(dphe);
            ...
            dtgaku7 = seisanbl.D_DepositHistory_Gaku_Select(dphe);
            ...
            dtgaku9 = seisanbl.D_DepositHistory_Gaku_Select(dphe);
            ...
            dtgaku8 = seisanbl.D_DepositHistory_Gaku_Select(dphe);
            ...
            dtgaku6 = seisanbl.D_DepositHistory_Gaku_Select(dphe);
