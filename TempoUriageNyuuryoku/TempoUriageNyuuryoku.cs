...
namespace TempoUriageNyuuryoku
{
    ...
    internal partial class TempoUriageNyuuryoku : FrmMainForm
    {
            ...
            for (W_CtlRow = 0; W_CtlRow <= mGrid.g_MK_Ctl_Row - 1; W_CtlRow++)
            {
                for (int w_CtlCol = 0; w_CtlCol <= mGrid.g_MK_Ctl_Col - 1; w_CtlCol++)
                {
                    if (mGrid.g_MK_Ctrl[w_CtlCol, W_CtlRow].CellCtl != null)
                    {
                        ...
                        //else if (mGrid.g_MK_Ctrl[w_CtlCol, W_CtlRow].CellCtl.GetType().Equals(typeof(GridControl)))
                        //{
                        //    GridControl.clsGridCheckBox check = (GridControl.clsGridCheckBox)mGrid.g_MK_Ctrl[w_CtlCol, W_CtlRow].CellCtl;
                        //    check.Enter += new System.EventHandler(GridControl_Enter);
                        //    check.Leave += new System.EventHandler(GridControl_Leave);
        ...
        private void S_SetControlArray()
        {
            ...
            mGrid.g_MK_Ctrl[(int)ClsGridTempoUriage.ColNO.CommentOutStore, 0].CellCtl = IMN_SALEP2_0;
            ...
            mGrid.g_MK_Ctrl[(int)ClsGridTempoUriage.ColNO.CommentOutStore, 1].CellCtl = IMN_SALEP2_1;
            ...
            mGrid.g_MK_Ctrl[(int)ClsGridTempoUriage.ColNO.CommentOutStore, 2].CellCtl = IMN_SALEP2_2;
            ...
            mGrid.g_MK_Ctrl[(int)ClsGridTempoUriage.ColNO.CommentOutStore, 3].CellCtl = IMN_SALEP2_3;
            ...
            mGrid.g_MK_Ctrl[(int)ClsGridTempoUriage.ColNO.CommentOutStore, 4].CellCtl = IMN_SALEP2_4;
            ...
            mGrid.g_MK_Ctrl[(int)ClsGridTempoUriage.ColNO.CommentOutStore, 5].CellCtl = IMN_SALEP2_5;
            ...
            mGrid.g_MK_Ctrl[(int)ClsGridTempoUriage.ColNO.CommentOutStore, 6].CellCtl = IMN_SALEP2_6;
            ...
            mGrid.g_MK_Ctrl[(int)ClsGridTempoUriage.ColNO.CommentOutStore, 7].CellCtl = IMN_SALEP2_7;
            ...
            mGrid.g_MK_Ctrl[(int)ClsGridTempoUriage.ColNO.CommentOutStore, 8].CellCtl = IMN_SALEP2_8;
            ...
            mGrid.g_MK_Ctrl[(int)ClsGridTempoUriage.ColNO.CommentOutStore, 9].CellCtl = IMN_SALEP2_9;
            ...
            mGrid.g_MK_Ctrl[(int)ClsGridTempoUriage.ColNO.CommentOutStore, 10].CellCtl = IMN_SALEP2_10;
                ...
                case 0:
                    {
                        ...
                        else
                        {
                            ...
                            if (OperationMode == EOperationMode.INSERT)
                            {
                                ...
                                detailControls[(int)EIndex.JuchuuDateTo].Text = bbl.GetDate();
                                F9Visible = false;
                ...
                case 1: //修正時
                    {
                            ...
                            for (w_Row = mGrid.g_MK_State.GetLowerBound(1); w_Row <= mGrid.g_MK_State.GetUpperBound(1); w_Row++)
                            {
                                ...
                                for (int w_Col = mGrid.g_MK_State.GetLowerBound(0); w_Col <= mGrid.g_MK_State.GetUpperBound(0); w_Col++)
                                {
                                    ...
                                    { 
                                        ...
                                        case (int)ClsGridTempoUriage.ColNO.CommentOutStore:
                                            {
                                                mGrid.g_MK_State[w_Col, w_Row].Cell_Enabled = true;
                                                break;
                                            }                                         
                        ...
                        else
                        {
                            ...
                            Scr_Lock(2, 3, 0);
                            //Scr_Lock(0, 1, 1);
                            SetFuncKeyAll(this, "110101000011");
                        }
                        break;
                    }
            ...
            else
            {
                ...
                foreach (DataRow row in dtDetail.Rows)
                {
                    ...
                    else
                    {
                        ...
                        {
                            if(!String.IsNullOrEmpty(row["BillingNO"].ToString()))
                            {
        ...
        private bool CheckDetail(int index, bool set=true)
        {
            ...
            switch (index)
            {
                ...
                case (int)EIndex.SalesDateTo:
                    ...
                    if (OperationMode == EOperationMode.INSERT)
                    {
                        if ( index == (int)EIndex.JuchuuDateTo)
                        {
                            if (!RequireCheck(new Control[] { detailControls[index] }))
                            {
                                return false;
                ...
                if (mGrid.g_DArray[RW].Chk)
                {
                    ...
                    if (OperationMode == FrmMainForm.EOperationMode.INSERT)
                    {
                        dt.Rows.Add(mGrid.g_DArray[RW].JuchuuNO
                             ...
                             ,mGrid.g_DArray[RW].CommentOutStore
        ...
        protected override void ExecSec()
        {
            ...
            for (int RW = 0; RW <= mGrid.g_MK_Max_Row - 1; RW++)
            {
                ...
                //画面.即請求チェックボックスOFFの場合
                if (!ChkSokuSeikyu.Checked)
                {
                    if (mGrid.g_DArray[RW].Chk)
                    {
                        string customerCD = mGrid.g_DArray[RW].CustomerCD;
                        ///string billingDate = mGrid.g_DArray[w_Row].SalesDate;

                        //請求処理済CHK
                        if (!CheckShime(customerCD))
                        {
        ...
        private void GridControl_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                    ...
                    ((e.KeyCode & (Keys.Alt | Keys.Control)) == Keys.None))
                {
                    ...
                    {
                        case "CHK_EDICK":
                            CL = (int)ClsGridTempoUriage.ColNO.Chk;
                            break;
                        case "IMN_SALEP2":
                            CL = (int)ClsGridTempoUriage.ColNO.CommentOutStore;
        ...
        private void CHK_Del_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!ChkSokuSeikyu.Checked)
                {
                    ...
                    {
                        string customerCD = mGrid.g_DArray[w_Row].CustomerCD;
                        ///string billingDate = mGrid.g_DArray[w_Row].SalesDate;
        ...
        /// <returns></returns>
        private bool CheckShime(string customerCD)
        {
            ...
            D_BillingProcessing_Entity dbe = new D_BillingProcessing_Entity
            {
                ...
                BillingDate = detailControls[(int)EIndex.SalesDate].Text
            };

            bool ret = tubl.CheckShimeZumi(dbe);
        ...
        private bool CheckGrid(int col, int row, bool chkAll = false, bool changeYmd = false, bool IsExec = false)  // PTK_M
        {
            ...
            if (!chkAll && !changeYmd)  // check length
            {
                ...
                if (w_CtlRow < ClsGridTempoUriage.gc_P_GYO)
            ...
            //    case (int)ClsGridTempoUriage.ColNO.CommentOutStore:
            //        string strR = Encoding.GetEncoding(932).GetByteCount(mGrid.g_DArray[row].CommentOutStore).ToString();
        ...
        private void BtnSelectAll_Click(object sender, EventArgs e)
        {
            if (dtDetail.Rows.Count > 0)
            {
                ...
                for (int RW = 0; RW <= mGrid.g_MK_Max_Row - 1; RW++)
                {
                    if (OperationMode == FrmMainForm.EOperationMode.INSERT)
                    {
                        if (!String.IsNullOrEmpty(mGrid.g_DArray[RW].JuchuuNO)
                               || !String.IsNullOrEmpty(mGrid.g_DArray[RW].JuchuuRows)
                              || !String.IsNullOrEmpty(mGrid.g_DArray[RW].JuchuuSuu))
                        {
                    ...
                    {
                        if (!String.IsNullOrEmpty(mGrid.g_DArray[RW].SalesNO)
                             || !String.IsNullOrEmpty(mGrid.g_DArray[RW].SalesRows)
                             || !String.IsNullOrEmpty(mGrid.g_DArray[RW].SalesSU)
                             )
                        {
                            mGrid.g_DArray[RW].Chk = true;
                        }
