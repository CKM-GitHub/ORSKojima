...
namespace TempoRegiKaiinTouroku_CustomerDetail
{
    public partial class Frm_TempoRegiKaiinTouroku_CustomerDetail : ShopBaseForm
    {
        ...
        {
            if(!RequireCheck(new Control[] { txtLastName,txtFirstName,txtKanaName}))
            {
                return false;
            }
        ...
        {           
            ...
            if(cust != null)
            {
                ...
                txtNameLong.Text = cust.CustomerName;
                ...
                rdoOther.Checked = cust.Sex.Equals("0") ? true : false;
        ...
        {
            txtNameLong.Text = txtLastName.Text + txtFirstName.Text;
        }
