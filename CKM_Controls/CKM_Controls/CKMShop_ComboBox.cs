    ...
    public partial class CKMShop_ComboBox : ComboBox
    {
        ...
        public void EnableDisplayCombo_DrawItem(object sender, DrawItemEventArgs e)  //PTK Added
        {
            ...
            if (e.Index >= 0)
            {
                ...
                int ym = Math.Round((e.Bounds.Height - e.Graphics.MeasureString(label, e.Font).Height) / 2).ToInt32(0);
                ...
                if (e.State == (DrawItemState.Disabled | DrawItemState.NoAccelerator | DrawItemState.NoFocusRect | DrawItemState.ComboBoxEdit))
                {
                    ...
                    TextRenderer.DrawText(e.Graphics, label, e.Font, new Rectangle(e.Bounds.X, e.Bounds.Y + ym, e.Bounds.Width, e.Bounds.Height), ForeColor, TextFormatFlags.Left | TextFormatFlags.Left);
