        ...
        public void Bind(string changeDate, string type = null)
        {
            ...
            switch (Cbo_Type)
            {
                ...
                case CboType.サイト種類:
                    ...
                    //case CboType.Warehouse:
                    //    Search_Souko_BL zaikoBL = new Search_Souko_BL();
                    //    GetLoginInformations();
                    //    DataTable dtSoukoSelectDataForZaiko = zaikoBL.M_Souko_BindForZaiko();
                    //    BindFirstData("SoukoCD", "SoukoName", dtSoukoSelectDataForZaiko);
                    //    break;
                    ...
                    //case CboType.Tanaban:     // チェックシートNo 3081, 3083
                    //    Search_Souko_BL sblt = new Search_Souko_BL();
                    //    M_Souko_Entity tsentity = new M_Souko_Entity();
                    //    tsentity.ChangeDate = changeDate;
                    //    GetLoginInformations();
                    //    tsentity.StoreCD = StoreCD;
                    //    DataTable dtSoukoSelectTana = sblt.M_Souko_BindForTanaban(tsentity);
                    //    BindFirstData("SoukoCD", "SoukoName", dtSoukoSelectTana);
                    //    break;

                    //case CboType.発注入力倉庫:    
                    //    Search_Souko_BL srsbl = new Search_Souko_BL();
                    //    M_Souko_Entity mskse = new M_Souko_Entity();
                    //    mskse.DeleteFlg = "0";
                    //    mskse.ChangeDate = changeDate;
                    //    GetLoginInformations();
                    //    mskse.StoreCD = StoreCD;
                    //    DataTable dtSoukoHacchuu = srsbl.M_Souko_BindForHacchuuNyuuryoku(mskse);
                    //    BindFirstData("SoukoCD", "SoukoName", dtSoukoHacchuu);
                    //    break;

                    //case CboType.StoreMainSouko:
                    //    //Only SoukoType = 3
                    //    var eStoreMainSouko = new M_Souko_Entity()
                    //    {
                    //        StoreCD = StoreCD.ToStringOrNull(),
                    //        ChangeDate = changeDate
                    //    };
                    //    DataTable dtStoreMainSouko = new Search_Souko_BL().M_Souko_BindForStoreMainSouko(eStoreMainSouko);
                    //    BindCombo("SoukoCD", "SoukoName", dtStoreMainSouko);
                    //    break;
                    #endregion
