...
namespace CKM_Controls
{
    public class CKM_TextBox : TextBox
    {
      ...
      //  [DisplayName("MaximumLength(Byte Count)")]
        ...
        //No.3271 Change start
        public InsertKeyMode InsertKeyMode { get; set; } = InsertKeyMode.Overwrite;
        public bool EnabledInsertKeyModeOnMouseEnter { get; set; } = false;
            ...
            set
            {
                ...
                switch (Font_Size)
                {
                    ...
                    case FontSize.XXLarge:
                        ...
                        break;
                    case FontSize.Specified: //Task3319
                        break;
                }
            }
        }
        ...
        protected override void OnEnter(EventArgs e)
        {
            ...
            if (this.InsertKeyMode == InsertKeyMode.Overwrite)
            {
                this.SelectAll();
            }
            base.OnEnter(e);
        ...
        {
            if (isFirstMousedown && EnabledInsertKeyModeOnMouseEnter)
            {
                if (this.InsertKeyMode == InsertKeyMode.Overwrite)
                {
                    this.SelectAll();
